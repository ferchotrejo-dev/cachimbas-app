                ...
                <form @submit.prevent="createUser" class="w-full lg:w-1/2 p-16 flex justify-center flex-wrap flex-col">
                    ...
                    <div>
                        <div class="flex flex-wrap my-6">
                            <label for="nombre" class="uppercase text-white font-bold text-xl">Nombre del
                                Usuario</label>
                        ...
                        <div class="flex flex-wrap my-6">
                            <label for="apellido" class="uppercase text-white font-bold text-xl">Apellido del Usuario
                            </label>
                        ...
                        <div class="flex flex-wrap my-6">
                            <label for="correo" class="uppercase text-white font-bold text-xl">
                                Correo del Usuario
                            </label>
                            <input id="correo" type="text" placeholder="CORREO USUARIO"
                                class="bg-gray-800 rounded-xl text-center p-2 w-full font-bold text-white"
                                v-model="newUserData.correo">
                        </div>

                        <div class="flex flex-wrap my-6">
                            <label for="password_confirmation" class="uppercase text-white font-bold text-xl">
                                Rol
                            </label>
                            <select id="rol" class="bg-gray-800 rounded-xl text-center p-2 w-full font-bold text-white"
                                v-model="newUserData.rol">
                                <option value="">-- Selecciona una Opcion --</option>
                                <option v-for="rol in data" :key="rol._id" :value="rol._id.toString()">
                                    {{ rol.nombre_rol }}
                                </option>
