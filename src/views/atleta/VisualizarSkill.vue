...
import { getAthlete, getSkills, getUser } from '@/api/AtletasAPI';
import SkillCard from '@/components/atleta/SkillCard.vue';
...
<template>
    <div class="bg-gray-950 w-full rounded-3xl p-5 ">
        ...
        <div class="w-full flex flex-wrap justify-center">
            <h1 class="text-white uppercase text-3xl font-bold mb-5 text-center w-full">Buscar Skill</h1>
            <input type="text" placeholder="Ingresa el nombre del ejercicio o habilidad"
