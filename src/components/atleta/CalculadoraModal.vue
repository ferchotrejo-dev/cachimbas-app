    ...
    <div class="modal">
        ...
        >
            ...
            >
                ...
                <legend class="uppercase text-blue-600 font-bold text-3xl md:text-5xl text-center my-8">Añadir Porcentaje</legend>
                ...
                >
                    <label 
                        for="porcentaje"
                        class="text-center text-3xl font-bold text-white uppercase"
                    >
                        Porcentaje %
                    </label>
                    <input 
                ...
                >
                    <label 
                        for="barra"
                        class="text-center text-3xl font-bold text-white mt-4 uppercase"
                    >
                        Barra LB
                    </label>
                    <select 
